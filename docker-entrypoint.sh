...
# Always sync Claude config files from repo (CLAUDE.md, rules, skills, hooks, settings)
...
cp -rf /app/Claude/hooks /home/node/.claude/
cp -f /app/Claude/settings.json /home/node/.claude/
